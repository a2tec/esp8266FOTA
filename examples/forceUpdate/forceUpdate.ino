...
// esp8266fota esp8266fota("<Type of Firme for this device>", <this version>);
esp8266FOTA esp8266FOTA("esp8266-fota-http", 1);
...
{
  delay(2000);
  esp8266FOTA.forceUpdate("192.168.0.100", 80, "/fota/esp8266-fota-http-2.bin")
}
